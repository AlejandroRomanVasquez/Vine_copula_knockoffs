...
#Exporting the results to csv file
write.csv(df_noncvine_results, file = "df_noncvine_results_t_Markov_X.csv", row.names = FALSE)
...
#Exporting the results to csv file
write.csv(df_cvine_results, file = "df_cvine_results_t_Markov_X.csv", row.names = FALSE)

results_cvine <- df_cvine_results%>% group_by(Ordinals_Proportion) %>%
  summarise(meanPower = mean(Cvine_power),meanFDP = mean(Cvine_FDP) )
View(results_cvine)
