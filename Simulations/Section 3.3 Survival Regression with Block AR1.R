...
#Exporting the results to csv file
write.csv(df_noncvine_results, file = "df_noncvine_results_Survival_nonGaussian_X.csv", row.names = FALSE)
...
#Exporting the results to csv file
write.csv(df_cvine_results, file = "df_cvine_results_Survival_nonGaussian_X.csv", row.names = FALSE)
