...
# Read CSV files
df_simulations_results_1 <- read.csv("df_nondvine_results_Survival_Cvine_X.csv")
df_simulations_results_2 <- read.csv("df_dvine_results_Survival_Cvine_X.csv")
df_simulations_results_3 <- read.csv("df_noncvine_results_Survival_Cvine_X.csv")
df_simulations_results_4 <- read.csv("df_cvine_results_Survival_Cvine_X.csv")
df_simulations_results_5 <- read.csv("df_second_order_results_Survival_Cvine_X.csv")
df_simulations_results_6 <- read.csv("df_sequential_results_Survival_Cvine_X.csv")
df_simulations_results_7 <- read.csv("df_lasso_results_Survival_Cvine_X.csv")
df_simulations_results_8 <- read.csv("df_SCAD_results_Survival_Cvine_X.csv")
...
# Save plots
ggsave("Survival_Cvines.eps", width = 20, height = 8, plot = grid.arrange(power_plot, fdr_plot2,widths=c(1.45,1), ncol = 2), 
       device = "eps", dpi = 1200, units = "cm")

ggsave("Survival_Cvines.jpg", width = 20, height = 8, plot = grid.arrange(power_plot, fdr_plot2,widths=c(1.45,1), ncol = 2), 
